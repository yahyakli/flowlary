...
export function RecentTransactions({ 
  ...
  const transactionsList = (
    <div className="space-y-3">
      ...
      {transactions.map((transaction) => {
        ...
        const isIncome = !hideGainIndicators && transaction.amount > 0;
  ...
  if (noContainer) return transactionsList;
