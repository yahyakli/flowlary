...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body suppressHydrationWarning className="min-h-full overflow-x-hidden bg-slate-50 text-slate-950 antialiased transition-colors duration-300 dark:bg-slate-950 dark:text-slate-50">
        <ThemeProviderWrapper>
          <SessionProvider>
            <div className="relative min-h-screen bg-slate-50 text-slate-950 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-50">
